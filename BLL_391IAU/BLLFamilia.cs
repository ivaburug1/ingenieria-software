...
namespace BLL_391IAU
{
    public class BLLFamilia_391IAU
    {
        ...
        public void AsociarSubfamilia(int idPadre, int idHija)
        {
            DAL.AsociarSubfamilia(idPadre, idHija);
        }
        public void EliminarTodasLasRelacionesFamiliaSubfamilia(int idFamiliaPadre)
        {
            DAL.EliminarTodasLasRelacionesFamiliaSubfamilia(idFamiliaPadre);
        }
